...
namespace Giti.Code
{
    ...
    public class BasicAuthenticationOptions : AuthenticationSchemeOptions, IOptions<BasicAuthenticationOptions>
    {
        ...
        public async Task<ClaimsPrincipal> SignInAsync(string userName, string password)
        {
            ...
            {
                var _signInManager = serviceScope.ServiceProvider.GetService<SignInManager<ApplicationUser>>();               
    ...
    public static class BasicAuthenticationExtensions
    {
        public static AuthenticationBuilder AddBasic(this AuthenticationBuilder builder)
            => builder.AddBasic(BasicAuthenticationDefaults.AuthenticationScheme, _ => { _.ServiceCollection = builder.Services;_.Realm = "Giti"; });
